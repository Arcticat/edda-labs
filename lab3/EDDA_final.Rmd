...
##### a)
The interest of contingency table test is in a possible dependency of the two factors. Thus it is suitable and appropriate for studying possible dependency between Austen's novels and an Austen's admirer's novel by counting the number of different words. 
