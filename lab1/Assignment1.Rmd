...
plot(nu,power,type="p"); lines(nu,power2,type="p",col="red");
```
...
plot(nu,power,type="p"); lines(nu,power2,type="p",col="red"); lines(nu,power3,type="p",col="blue");
```
...
par(mfrow = c(1,2))
hist(data$Bills,prob=T); qqnorm(data$Bills, main = "QQ plot of data$Bills")
```
...
```{r}
lamda=seq(0.01,0.1,by=0.01); length(lamda);bills=data$Bills
t=median(bills);
B=1000; tstar=numeric(B)
